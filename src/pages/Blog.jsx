  ...
  return (
    <div className="min-h-screen bg-secondary-50 py-16 dark:bg-secondary-900">
      <div className="container">
        ...
        >
          <h1 className="text-4xl font-bold mb-4 dark:text-secondary-100">Real Estate & Crypto Insights</h1>
          ...
          {filteredPosts.map((post, index) => (
            ...
            >
              <Link to={`/blog/${post.slug}`}>
                ...
                <div className="p-6">
                  <h2 className="text-xl font-semibold mb-3 hover:text-primary-600 transition-colors dark:text-secondary-100">
                    {post.title}
                  </h2>
